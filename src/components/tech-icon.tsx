...
import { faAws, faReact, faJs, faDocker, faRaspberryPi, faCss3, faHtml5, faWindows, faLinux, faFirefox, faFirefoxBrowser } from "@fortawesome/free-brands-svg-icons";
